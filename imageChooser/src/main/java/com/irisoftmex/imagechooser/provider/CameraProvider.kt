package com.irisoftmex.imagechooser.provider
...
import com.irisoftmex.imagechooser.util.FileUtil
import com.irisoftmex.imagechooser.util.IntentUtils
import com.irisoftmex.imagechooser.util.PermissionUtil
import java.io.File
...
class CameraProvider(activity: ImagePickerActivity) : BaseProvider(activity) {
    ...
    private fun startCameraIntent() {
        ...
        if (file != null && file.exists()) {
            val cameraIntent = IntentUtils.getCameraIntent(this, file) ?: return
