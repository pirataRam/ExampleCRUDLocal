...
object Constants {
    ...
    fun getMunicipiosByEstado(estado: String): List<String> = when(estado){
        "Aguascalientes" -> municipiosAgs
        "Baja California" -> municipiosBC
        "Baja California Sur" -> municipiosBCS
        "Campeche" -> municipiosCamp
        "Chiapas" -> municipiosChis
        "Chihuahua" -> municipiosChih
        "Ciudad de México" -> municipiosCdMx
        "Coahuila de Zaragoza" -> municipiosCoah
        "Colima " -> municipiosCol
        "Durango" -> municipiosDgo
        "Estado de México" -> municipiosEdoMex
        "Guanajuato" -> municipiosGto
        "Guerrero" -> municipiosGro
        "Hidalgo" -> municipiosHgo
        "Jalisco" -> municipiosJal
        "Michoacán de Ocampo" -> municipiosMich
        "Morelos" -> municipiosMors
        "Nayarit" -> municipiosNay
        "Nuevo León" -> municipiosNvoLeon
        "Oaxaca" -> municipiosOax
        "Puebla" -> municipiosPue
        "Querétaro" -> municipiosQro
        "Quintana Roo" -> municipiosQRoo
        "San Luis Potosí" -> municipiosSLP
        "Sinaloa" -> municipiosSin
        "Sonora" -> municipiosSon
        "Tabasco" -> municipiosTab
        "Tamaulipas" -> municipiosTamps
        "Tlaxcala" -> municipiosTlax
        "Veracruz de Ignacio de la Llave" -> municipiosVer
        "Yucatán" -> municipiosYuc
        "Zacatecas" -> municipiosZac
        else -> emptyList()
    }
}